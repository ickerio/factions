...
public class AdminGui extends SimpleGui {
    ...
    public AdminGui(ServerPlayerEntity player) {
        ...
        this.setSlot(indexes.get(0), new GuiElementBuilder(Items.PLAYER_HEAD)
            .setSkullOwner(user.bypass ? Icons.GUI_TESSERACT_ACTIVE : Icons.GUI_TESSERACT_INACTIVE)
            ...
            .setCallback((index, clickType, actionType) -> {
                ...
                map.put("textures", new Property("textures", user.bypass ? Icons.GUI_TESSERACT_ACTIVE : Icons.GUI_TESSERACT_INACTIVE, null));
