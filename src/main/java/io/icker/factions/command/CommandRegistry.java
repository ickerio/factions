...
public class CommandRegistry {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
		...
		LiteralCommandNode<ServerCommandSource> admin = CommandManager
			.literal("admin")
			.requires(s -> PermissionsWrapper.exists() ? PermissionsWrapper.require(s, "factions.admin") : s.hasPermissionLevel(Config.REQUIRED_BYPASS_LEVEL))
			.build();

		LiteralCommandNode<ServerCommandSource> reload = CommandManager
			.literal("reload")
			.requires(s -> PermissionsWrapper.exists() ? PermissionsWrapper.require(s, "factions.admin.reload") : s.hasPermissionLevel(Config.REQUIRED_BYPASS_LEVEL))
